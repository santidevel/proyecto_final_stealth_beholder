...
RAW_DIRS = {
    "apex":  ruta("data", "raw_dataset", "Apex_Legends"),
    "forza": ruta("data", "raw_dataset", "Forza_Horizon"),
}
...
OUT_DIRS = {
    "apex_menus":       ruta("data", "dataset", "apex_menus"),
    "apex_victoria":    ruta("data", "dataset", "apex_victoria"),
    "apex_jugando":     ruta("data", "dataset", "apex_jugando"),
    "apex_racha":       ruta("data", "dataset", "apex_racha"),
    "apex_kill_leader": ruta("data", "dataset", "apex_kill_leader"),
    "forza_carrera":    ruta("data", "dataset", "forza_carrera"),
    "forza_menus":      ruta("data", "dataset", "forza_menus"),
    "forza_primero":    ruta("data", "dataset", "forza_primero"),
    "forza_victoria":   ruta("data", "dataset", "forza_victoria"),
}
